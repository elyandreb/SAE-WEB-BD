...
ALTER TABLE COURS ADD FOREIGN KEY (id_u) REFERENCES USER (id_u);
ALTER TABLE RESERVER ADD FOREIGN KEY (id_u) REFERENCES USER (id_u);
...
ALTER TABLE COTISER ADD FOREIGN KEY (id_u) REFERENCES USER (id_u);
