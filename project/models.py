...
class Reserver(db.Model):
    ...
    adherent = db.relationship('User', back_populates='reservations')
...
class Cours(db.Model):
    ...
    id_m = db.Column(db.Integer, db.ForeignKey('User.id_u'))
...
class Cotiser(db.Model):
    ...
    id_a = db.Column(db.Integer, db.ForeignKey('USER.id_u'), primary_key=True)
    ...
    adherent = db.relationship('User', back_populates='cotisations')
